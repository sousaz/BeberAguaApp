...
export default function SettingsScreen() {
    ...
    }, [isDarkMode, notificationsEnabled, interval, goal]);
  
    const loadSettings = async () => {
      try {
        const savedSettings = await AsyncStorage.getItem(SETTINGS_PATH);
        if (savedSettings) {
          const { enabled, interval: savedInterval, theme: savedTheme, goal: savedGoal } = JSON.parse(savedSettings);
